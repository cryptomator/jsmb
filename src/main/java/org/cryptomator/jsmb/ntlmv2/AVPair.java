 ...
 */
record AVPair(MemorySegment segment) {

	public static final char MSV_AV_EOL = 0x0000;
	public static final char MSV_AV_NB_COMPUTER_NAME = 0x0001;
	public static final char MSV_AV_NB_DOMAIN_NAME = 0x0002;
	public static final char MSV_AV_DNS_COMPUTER_NAME = 0x0003;
	public static final char MSV_AV_DNS_DOMAIN_NAME = 0x0004;
	public static final char MSV_AV_DNS_TREE_NAME = 0x0005;
	public static final char MSV_AV_FLAGS = 0x0006;
	public static final char MSV_AV_TIMESTAMP = 0x0007;
	public static final char MSV_AV_SINGLE_HOST = 0x0008;
	public static final char MSV_AV_TARGET_NAME = 0x0009;
	public static final char MSV_AV_CHANNEL_BINDINGS = 0x000A;
	...
	public static SequencedMap<Character, AVPair> parse(MemorySegment segment) {
		var result = new LinkedHashMap<Character, AVPair>();
		parse(segment, result);
		return result;
	}

	private static void parse(MemorySegment segment, SequencedMap<Character, AVPair> result) {
		if (segment.byteSize() < 4) {
			throw new IllegalArgumentException("Segment too small for AVPair");
		}
		...
		result.put(avId, new AVPair(avPairSegment));
		if (avId != MSV_AV_EOL) {
	...
	public int valueAsInt() {
		return value().get(Layouts.LE_INT32, 0);
	}
}
