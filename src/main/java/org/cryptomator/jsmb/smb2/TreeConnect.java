 ...
 * @param share         the embedder-provided backend behind the share, or {@code null} for the administrative {@code IPC$} pipe tree
 ...
 */
public record TreeConnect(int treeId, String shareName, @Nullable SmbShare share, int maximalAccess) {}
